...
class CheckNoteCorrectTest {
    ...
    fun setup() {
        ...
        // Mock PitchDetector to simulate correct note
        ...
        TestUtils.setupTestUser("check1")
    }
    ...
    fun tearDown() {
        ...
        TestUtils.cleanupTestUser("check1")
    }

    @Test
    fun checkNoteCorrectTest() {
        // Wait for recycler
        ...
        // Open Basic Sheets
        onView(
            allOf(withId(R.id.recyclerView), childAtPosition(withId(R.id.constraint), 0))
