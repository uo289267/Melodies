...
class NicknameTooLong {
    ...
    fun nicknameTooLong() {
        ...
        appCompatEditText.perform(replaceText("012345678901234567890"))
        ...
        onView(withId(R.id.input))
            .check(matches(hasErrorText("New nickname cannot be more than 20 chars long")))
