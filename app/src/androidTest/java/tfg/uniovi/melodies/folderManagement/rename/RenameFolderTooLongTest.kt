...
class RenameFolderTooLongTest {
    ...
    fun renameFolderTooLongTest() {
        ...
        device.wait(Until.hasObject(By.textContains("Folder's name cannot be longer than 30 characters")), 2000)

        // Verify error text "Folder name too long"
