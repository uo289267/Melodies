...
class CreateFolderTooLongTest {
    ...
    @Test
    fun createFolderTooLongNameShowsError() {
        ...
        inputField?.text = "0123456789012345678901234567890"
        Thread.sleep(1000)
        ...
        onView(allOf(
            ...
            withText(containsString("Folder's name cannot be longer than 30 characters"))
